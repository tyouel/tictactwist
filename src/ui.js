...
import { createBoard, getWinner, isDraw, applyMove, getValidMoves, nextPlayer, WINNING_LINES } from './game.js?v=19replay';
import { getAIMove } from './ai.js?v=19replay';
import {
...
import { getSlideAIMove } from './slide-ai.js?v=19replay';
import { loadSettings, saveSettings, loadScore, saveScore, resetScore } from './storage.js?v=19replay';
